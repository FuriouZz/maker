...
extern int mk_frame_queue_init(MKFrameQueue *queue, MKPacketQueue *packet_queue,
                               int frame_count, int keep_last);

extern void mk_frame_queue_destroy(MKFrameQueue *queue);

extern void mk_frame_queue_unref_item(MKFrameQueueItem *item);
...
extern void mk_frame_queue_push(MKFrameQueue *queue);

extern void mk_frame_queue_next(MKFrameQueue *queue);

extern int mk_frame_queue_remaining_frame_count(MKFrameQueue *queue);
